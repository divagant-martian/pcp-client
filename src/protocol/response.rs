...
pub enum ErrorCode {
    ...
    /// server.
    #[display(fmt = "sent version is not supported")]
    UnsuppVersion = 1,
    ...
    #[display(fmt = "spurious network failure")]
    NetworkFailure = 7,
    ...
    #[display(fmt = "not enough resources for this request")]
    NoResources = 8,
...
pub enum DecodeError {
    ...
    #[display(fmt = "Response is malformed")]
    Malformed,
    /// The [`Response::RESPONSE_INDICATOR`] is not present.
    #[display(fmt = "Packet does not appear to be a response")]
    NotAResponse,
    /// The received opcode is not recognized.
    #[display(fmt = "Invalid Opcode received")]
    InvalidOpcode,
    /// The received version is not recognized.
    #[display(fmt = "Invalid version received")]
    InvalidVersion,
    /// The received result code is not recognized.
    #[display(fmt = "Invalid result code received")]
    InvalidResultCode,
    /// The received opcode data could not be decoded.
    #[display(fmt = "Invalid opcode data received")]
    InvalidOpcodeData,
}
